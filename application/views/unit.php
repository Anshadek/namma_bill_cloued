...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <form class="form-horizontal" id="units-form" onkeypress="return event.keyCode != 13;">
                           ...
                           <div class="box-body">
                              ...
                              <!-- Store Code end -->
                                 ...
                                 <label for="warehouse" class="col-sm-2 control-label"><?= $this->lang->line('warehouse'); ?><label class="text-danger">*</label></label>
                                 <div class="col-sm-4">
      ...
      <script src="<?php echo $theme_link; ?>js/units.js?v=1"></script>
