         ...
         <div style="margin-top:30px" class="row">
            <section>
               <div class="col-md-6">
                  ...
                  if (true) {
                  echo'<label for="expire_date" class="col-sm-2 control-label">Warehouse</label><select class="form-control select2 " id="warehouse_id" name="warehouse_id"  onchange="get_warehouse_details(this)">';
                    echo get_warehouse_select_list($warehouse_id, get_current_store_id());
                  echo '</select>';
                  ...
                  <div class="col-md-3">
                  <label for="expire_date" class="col-sm-2 control-label">Start</label>
                  <input type="text" class="form-control pull-right datepicker"  id="start_date" name="start_date" readonly onchange="filter_p_l()" value="">
            
                  </div>
                  <div class="col-md-3">
                  <label for="expire_date" class="col-sm-2 control-label">End</label>
                  <input type="text" class="form-control pull-right datepicker"  id="end_date" name="end_date" readonly onchange="filter_p_l()" value="">
               </div>
