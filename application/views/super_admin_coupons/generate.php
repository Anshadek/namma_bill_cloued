...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<div class="box box-primary ">
							...
							<form class="form-horizontal" id="coupon-form">
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select class="form-control select2" id="customer_id" name="customer_id" style="width: 100%;">
												<?= get_store_select_list($customer_id, get_current_store_id());  ?>
											</select>
									...
									<div class="form-group">
										<label for="min_val" class="col-sm-2 control-label">Minimum Value <label class="text-danger">*</label></label>
										<div class="col-sm-4">
											<input type="text" class="form-control input-sm " id="min_val" name="min_val" value="">

											<span id="min_val_msg" style="display:none" class="text-danger"></span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<span id="max_val_msg" style="display:none" class="text-danger"></span>
										</div>
									</div>
									<div class="form-group">
										<label for="coupon_usage" class="col-sm-2 control-label">Coupon Usage<label class="text-danger">*</label></label>
										<div class="col-sm-4">
											<select class="form-control select2 select2-hidden-accessible" id="coupon_usage" name="coupon_usage" style="width: 100%;" tabindex="-1" aria-hidden="true">
												<option value="">-Select-</option>
												<option value="single">Single</option>
												<option value="multiple">Multiple</option>
											</select>

											<span id="coupon_usage_msg" style="display:none" class="text-danger"></span>
										</div>
									</div>
	...
	<script src="<?php echo $theme_link; ?>js/coupons/super_admin_generate.js"></script>
