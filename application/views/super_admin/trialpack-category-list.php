...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  Trial Pack Category
                  <small>Manage Trial Pack Category</small>
               </h1>
               <ol class="breadcrumb">
                  <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li class="active">Trial Pack</li>
               </ol>
            </section>
            <!-- Main content -->
                     ...
                     <div class="box box-primary">
                        <div class="box-header with-border">
                           <h3 class="box-title">Trial Pack List</h3>
							...
							<button onclick="addRow()" title="New Trial Pack Category?" class="btn btn-primary pull-right"> Add Trial Pack Categroy </button>                      <?php if($CI->permissions('warehouse_add')) { ?>
                            <div class="box-tools">
                        ...
                        <div class="box-body">
                           ...
                           <table id="example2" class="table table-bordered custom_hover" width="100%">
                              ...
                              <tbody>
                                 ...
                                 $CI =& get_instance();
                                    $i=1;
                                         $q1= $this->db->select("*")->get("db_trialpack_category");
                                    if($q1->num_rows()>0){
                                    ...
                                    <td>
                                       ...
                                       <div class="btn-group" title="View Account">
                                          ...
                                          <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                                             ...
                                             <li>
                                                <a title="Edit Record ?" onclick="editRow('<?= $res1->id ?>','<?= $res1->name ?>','<?= $res1->note ?>')">
                                                Edit
                                                </a>
                                             </li>
                                             ...
                                             <li>
                                                <a style="cursor:pointer" title="Delete Record ?" onclick="deleteRow('<?=$res1->id;?>')">
                                                Delete
                                                </a>
                                             </li>
                                          </ul>
         ...
         <div class="control-sidebar-bg"></div>
			...
			<?= form_open('#', array('class' => 'form-horizontal', 'id' => 'trialpack-category-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    <div class="modal-header header-custom">
                      ...
                      <h4 class="modal-title text-center">Add Trial Pack Category</h4>
                    </div>
      ...
      <script src="<?php echo $theme_link; ?>js/super_admin_trialpackage_category.js?v=1"></script>
      <script type="text/javascript">
         function deleteRow(id)
         {
          var base_url=$("#base_url").val();
            ...
            $.post(base_url+"super_admin/delete_trial_pack_category",{id:id},function(result){
            //alert(result);return;
              if(result=="success")
                 {
         ...
         $(document).ready(function() {
          ...
          /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
			...
			function addRow(params) {
				$('#trialpack-category-form')[0].reset();
				$('#id').val(0);
				$('#trial-pack-modal').modal('show'); 
			}
      </script>
