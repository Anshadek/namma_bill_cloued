		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					...
					<small>Manage Trial Store Subscription</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Trial Store Subscription List</li>
				</ol>
			</section>
			<!-- Main content -->
					...
					<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">Trial Store Subscription List</h3>
                                 ...
                                 $CI =& get_instance();
                                    ...
                                    if($q1->num_rows()>0){
										...
										<tr>
											...
											<td><span style="color:red;"><?php echo  date('Y-m-d', strtotime($res1->created_date. ' + '.$validity_in_days.' days')); ?></span> </td>
                                        ...
                                        if($res1->status=='active')                   //1=Active, 0=Inactive
                                          ...
                                          {
                                          echo "<span class='label label-danger' style='cursor:pointer'> Inactive </span>";
                                          }
                                          ?>
											</td>
											<td>
