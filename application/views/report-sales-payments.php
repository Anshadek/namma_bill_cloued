          ...
          if(to_date == "")
             {
               ...
               $.post("show_sales_payments_report",{store_id:store_id,payment_type:payment_type,customer_id:customer_id,from_date:from_date,to_date:to_date},function(result){
                 //alert(result);
                   setTimeout(function() {
