                          ...
                          <div class="col-md-4">
                            ...
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <label id="cust_warehouse_id_msg" class="text-danger text-right pull-right"></label>
                                
                                <select class="form-control" id="cust_warehouse_id" name="warehouse_id" style="width: 100%;">
