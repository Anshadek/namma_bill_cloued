   ...
   <body class="hold-transition skin-blue sidebar-mini">
      ...
      <script type="text/javascript">
        $("#view").on("click",function(){
            ...
            $.post($("#base_url").val()+"reports/show_sales_gst_report",{warehouse_id:warehouse_id,from_date:from_date,to_date:to_date,store_id:$("#store_id").val(),warehouse_id:$("#warehouse_id").val(),customer_id:customer_id},function(result){
                //alert(result);
                setTimeout(function() {
